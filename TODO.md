...
> 最后更新: 2026-07-31
>
> 完成 13/20 项 (65%)，剩余: 性能调优 / HTTPS / 官网上线 / 版本更新 / AI功能 / 插件系统 / 多语言支持
...
- ✅ 2026-07-31 收尾：路由全部注册（含 /api/users/create 向导、services 开关、quota GET/PUT）、恢复增强版 NASUser 列表与前端配套、修复 nogroup(GID 65534) 混入用户组列表
