...
# 配置别名
./mc alias set mynas http://192.168.213.85:9000 jacky <NAS_PASS>
...
```cmd
net use Z: \\192.168.213.85\shared /user:jacky <NAS_PASS> /persistent:yes
```
...
**Windows 映射 WebDAV：**
```cmd
net use W: http://192.168.213.85:8080/ /user:jacky <NAS_PASS>
```
